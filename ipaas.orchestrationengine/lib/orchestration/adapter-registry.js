 ...
 * load their own credentials (see @ipaas/adapter-connectwise and
 * @ipaas/adapter-keka — both are storage-agnostic by design now). This
 ...
 * @returns {Promise<import('@ipaas/adapter-connectwise').ConnectWiseAdapter
